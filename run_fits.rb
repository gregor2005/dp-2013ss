...
if ARGV.size != 1
  puts "usage: ruby run_fits.rb [output-directory]"
  exit
end
...
timeout=2
timeout_thread=60
fits="/mnt/daten1/0000/dp-assignment 1/fits/fits-0.6.1/fits.sh"
output_folder="/mnt/daten1/0000/dp-assignment 1/fits/fits-reports_privat"
threads={}
